#ifndef GAME_STATES_GSControlHandlers_H
#define GAME_STATES_GSControlHandlers_H
	...
	: public StateBase, public EEventReceiver
{
	...
	private:
		...
		Game 				*m_isGame;
		cUIObject			*m_ControlSWF;
};

#endif // GAME_STATES_GSControlHandlers_H
