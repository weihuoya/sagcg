...
namespace irr
{
	...
	namespace scene
	{
		...
		class SSkinnedMesh : public ISkinnedMesh
		{
			public:
				...
				{
					Mesh->setMaterialFlag ( flag,newvalue );
				}
				...
				{
					return Mesh->getJointName ( number );
				}
				...
				{
					return Mesh->useAnimationFrom ( mesh );
				}
				...
				struct AnimInfo
				{
					...
					//    AnimInfo( core::stringc& name, s32 begin = 0, s32 end = 0, f32 fps = 30.0f )
					{
						Name = name;
						Fps = fps;
						Begin = begin;
				...
				//    void addAnimation( core::stringc& animationName, s32 begin = 0, s32 end = 0, f32 fps = 30.0f )
				{
				...
				core::array<AnimInfo>& getAnimations( )
				{
					return Anims;
				}
				const core::array<AnimInfo>& getAnimations( ) const
				{
					return Anims;
				}
