...
//
// /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef GAME_SaGCG_OpenOfficeContextLoader_H
#define GAME_SaGCG_OpenOfficeContextLoader_H


class OpenOfficeContextLoader
{
	public:
		/** Default constructor */
		OpenOfficeContextLoader ( IrrlichtDevice *irrlichtdevice, const irr::c8 *OpenOfficeDocument, const c8 *contextfile=0 );
		bool  writeOpenOfficeDocumentTextToFile ( const char *newOpenOfficeDocumentFile );
		wchar_t *getOpenOfficeDocumentText()
		{
			return m_filebuffer;
		}
		long  getBufferSizeOpenOfficeDocumentText()
		{
			return m_Buffersize;
		}
		long  getFileSizeOpenOfficeDocumentText()
		{
			return m_Filesize;
		}

		/** Default destructor */
		virtual ~OpenOfficeContextLoader();
	protected:
	private:
...
#endif // GAME_SaGCG_OpenOfficeContextLoader_H
