#ifndef GAME_STATES_GSAlexGame_H
#define GAME_STATES_GSAlexGame_H
	...
	: public StateBase, public EEventReceiver
{
	...
	private:
		...
		scene::ISceneNode  *crazyskymesh1;
		scene::ISceneNode  *crazyskymesh2;
		int casenum;
		bool needstartnew;
...
#endif // GAME_STATES_GSAlexGame_H
